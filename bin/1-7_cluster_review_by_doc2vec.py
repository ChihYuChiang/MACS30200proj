...
#%%
#--Read in datahv 
df = pickle.load(open(r'..\data\process\score_original_doc2vec.p', 'rb'))
df_scores = df.filter(regex=('^group\d+$'))
...
plt.xticks(())
plt.yticks(())
plt.savefig(r'..\img\1-7_d2v_tsne')
plt.show()
plt.close()
...
plt.savefig(r'..\img\1-7_d2v_k-mean_PCA_' + str(numClusters))
plt.show()
...
plt.yticks(())
plt.title('Predicted Clusters\n k = {}'.format(numClusters))
plt.savefig(r'..\img\1-7_d2v_k-mean_tsne_' + str(numClusters))
plt.show()
...
for n_clusters in range_n_clusters:
    ...
    plt.savefig(r'..\img\1-7_d2v_silhouette_' + str(n_clusters))
    # plt.show()
    plt.close()