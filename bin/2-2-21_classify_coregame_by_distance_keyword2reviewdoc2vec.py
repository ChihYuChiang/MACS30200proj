...
coreVecs = df.query('Core > 0').filter(regex=('^f_\d+$'))
coreVecs.shape
...
df_core_expand = df_core_expand.sample(frac=1, random_state=1980)
...
plt.savefig(r'..\img\2-2-2_confusion_SVM_' + str(numOfCluster))
plt.show()
plt.close()
...
plt.xlabel('true label')
plt.ylabel('predicted label')
plt.savefig(r'..\img\2-2-2_confusion_NN_' + str(numOfCluster))
plt.show()
plt.close()
...
plt.xlabel('true label')
plt.ylabel('predicted label')
plt.savefig(r'..\img\2-2-2_confusion_RF_' + str(numOfCluster))
plt.show()
plt.close()
...
plt.xlabel('true label')
plt.ylabel('predicted label')
plt.savefig(r'..\img\2-2-2_confusion_NB_' + str(numOfCluster))
plt.show()
plt.close()
